...
enum {
  ER_BUS_WIDTH8_BYTES = ER_DRIVER_ABI_BUS_WIDTH8_BYTES,
  ER_BUS_WIDTH16_BYTES = ER_DRIVER_ABI_BUS_WIDTH16_BYTES,
  ER_BUS_WIDTH32_BYTES = ER_DRIVER_ABI_BUS_WIDTH32_BYTES,
  ER_BUS_BYTE_BITS = 8u,
