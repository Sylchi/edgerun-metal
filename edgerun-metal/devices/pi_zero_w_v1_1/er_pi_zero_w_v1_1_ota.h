...
#define ER_PI_ZERO_W_V1_1_OTA_L2_FRAME_BYTES_MAX \
  (ER_NET_ETH_HEADER_LEN + ER_PI_ZERO_W_V1_1_OTA_ERWIRE_PACKET_BYTES_MAX)
...
#define ER_PI_ZERO_W_V1_1_OTA_DEFAULT_SLOT_BLOCK 262144u
