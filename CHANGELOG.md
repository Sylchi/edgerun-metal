...
- Native ASM signing replacement started with `kernel/x86_64/crypto/sha512.asm`
  ...
  multiplication/encoding; normal and blinded Tor Ed25519 signing now use ASM.
  The signing-specific Zig/WASM guest, build target, and kernel incbin were removed.
