...
%ifndef HOSTED_TEST
    ...
    er_call er_dw_i2c_xfer, .fail_read
...
%ifndef HOSTED_TEST
    ...
    xor     r8, r8
    xor     r9d, r9d
    er_call er_dw_i2c_xfer, .fail_cmd
...
%ifndef HOSTED_TEST
    ...
    lea     r8, [rsp + 4]
    mov     r9d, 2
    er_call er_dw_i2c_xfer, .fail_reg16
...
%ifndef HOSTED_TEST
    ...
    movzx   esi, r13b
    lea     rdx, [rsp]
    er_call _i2c_hid_read_desc, .fail_probe
    ...
    mov     rdi, r12
    movzx   esi, r13b
    er_call _i2c_hid_write_cmd, .fail_probe
...
%ifndef HOSTED_TEST
    ...
    xor     r8, r8
    xor     r9d, r9d
    er_call er_dw_i2c_xfer, .fail_power
...
%ifndef HOSTED_TEST
    ...
    mov     r9d, r15d
    er_call er_dw_i2c_xfer, .fail_input
