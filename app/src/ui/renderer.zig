...
fn packedBuffers() renderer_ir.Buffers {
    return .{
        ...
        .text_vertices = packed_image_vertex_floats[0..],
        .text_vertex_len = &packed_image_vertex_float_len,
        .overlay_text_vertices = &.{},
        .overlay_text_vertex_len = &overlay_sentinel_len,
