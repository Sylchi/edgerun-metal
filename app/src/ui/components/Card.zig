...
const surface_shadow = ui.Color{ .r = 0, .g = 0, .b = 0, .a = 38 };
const surface_shadow_size: f32 = 5.0;
const surface_shadow_inset: f32 = 1.0;
const card_highlight = ui.Color{ .r = 255, .g = 255, .b = 255, .a = 3 };
const card_floor = ui.Color{ .r = 10, .g = 12, .b = 16, .a = 4 };
const card_rim = ui.Color{ .r = 255, .g = 255, .b = 255, .a = 4 };
