...
pub const app_location = @import("../location.zig");
...
pub const max_source_workspace_scratch_bytes: usize = max_source_workspace_bytes;
...
pub const max_packed_text_vertices: usize = 24576;
...
pub const location_path_projection_capacity: usize = app_location.path_projection_capacity;
pub const location_hash_projection_capacity: usize = app_location.hash_projection_capacity;
...
pub var source_workspace_scratch: [max_source_workspace_scratch_bytes]u8 align(16) = undefined;
...
pub var packed_text_vertex_floats: [max_packed_text_vertices * renderer_pipeline.text_vertex_float_stride]f32 = undefined;
pub var packed_text_vertex_float_len: usize = 0;
...
pub var location_path_projection_bytes: [location_path_projection_capacity]u8 = undefined;
pub var location_path_projection_len: usize = 0;
pub var location_hash_projection_bytes: [location_hash_projection_capacity]u8 = undefined;
pub var location_hash_projection_len: usize = 0;
...
pub const OutboxKind = enum(u32) {
    none = 0,
    open_url = 1,
    push_location_hash_projection = 2,
    set_title = 3,
    set_element_html = 4,
    download_wasm = 5,
    launch_wasm = 6,
