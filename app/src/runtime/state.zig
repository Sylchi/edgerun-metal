...
pub const location_path_projection_capacity: usize = app_navigation.path_projection_capacity;
pub const location_hash_projection_capacity: usize = app_navigation.hash_projection_capacity;
