...
pub const route_bytes_capacity: usize = app_navigation.path_projection_capacity;
pub const route_hash_bytes_capacity: usize = app_navigation.hash_projection_capacity;
