...
const app_images = app_bundle.app_images;
...
test "app runtime reveal derives public identity inside wasm from interaction" {
    ...
    try std.testing.expectEqual(@intFromEnum(UiAction.none), er_ui_app_activate_hit(app_navigation.reveal_identity_button_id));
