...
const float_min_max_copysign_wasm = [_]u8{
    0x00, 0x61, 0x73, 0x6d, 0x01, 0x00, 0x00, 0x00,
    0x01, 0x08, 0x01, 0x60, 0x00, 0x04, 0x7d, 0x7d,
    0x7d, 0x7c, 0x03, 0x02, 0x01, 0x00, 0x07, 0x08,
    0x01, 0x04, 'm',  'a',  'i',  'n',  0x00, 0x00,
    0x0a, 0x38, 0x01, 0x36, 0x00, 0x43, 0x00, 0x00,
    0x00, 0x80, 0x43, 0x00, 0x00, 0x00, 0x00, 0x96,
    0x43, 0x00, 0x00, 0x00, 0x80, 0x43, 0x00, 0x00,
    0x00, 0x00, 0x97, 0x43, 0x00, 0x00, 0xc0, 0x3f,
    0x43, 0x00, 0x00, 0x00, 0xc0, 0x98, 0x44, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0xf8, 0x3f, 0x44,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xc0,
    0xa6, 0x0b,
};

const f32_rounding_wasm = [_]u8{
    0x00, 0x61, 0x73, 0x6d, 0x01, 0x00, 0x00, 0x00,
    0x01, 0x08, 0x01, 0x60, 0x00, 0x04, 0x7d, 0x7d,
    0x7d, 0x7d, 0x03, 0x02, 0x01, 0x00, 0x07, 0x08,
    0x01, 0x04, 'm',  'a',  'i',  'n',  0x00, 0x00,
    0x0a, 0x1c, 0x01, 0x1a, 0x00, 0x43, 0x9a, 0x99,
    0x99, 0x3f, 0x8d, 0x43, 0x66, 0x66, 0xe6, 0x3f,
    0x8e, 0x43, 0x66, 0x66, 0xe6, 0xbf, 0x8f, 0x43,
    0x00, 0x00, 0x20, 0x40, 0x90, 0x0b,
};

const f64_rounding_wasm = [_]u8{
    0x00, 0x61, 0x73, 0x6d, 0x01, 0x00, 0x00, 0x00,
    0x01, 0x08, 0x01, 0x60, 0x00, 0x04, 0x7c, 0x7c,
    0x7c, 0x7c, 0x03, 0x02, 0x01, 0x00, 0x07, 0x08,
    0x01, 0x04, 'm',  'a',  'i',  'n',  0x00, 0x00,
    0x0a, 0x2c, 0x01, 0x2a, 0x00, 0x44, 0x33, 0x33,
    0x33, 0x33, 0x33, 0x33, 0xf3, 0x3f, 0x9b, 0x44,
    0xcd, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xfc, 0x3f,
    0x9c, 0x44, 0xcd, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc,
    0xfc, 0xbf, 0x9d, 0x44, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x04, 0x40, 0x9e, 0x0b,
};
...
const many_locals_wasm = [_]u8{
    0x00, 0x61, 0x73, 0x6d, 0x01, 0x00, 0x00, 0x00,
    0x01, 0x05, 0x01, 0x60, 0x00, 0x01, 0x7e, 0x03,
    0x02, 0x01, 0x00, 0x07, 0x08, 0x01, 0x04, 'm',
    'a',  'i',  'n',  0x00, 0x00, 0x0a, 0x0c, 0x01,
    0x0a, 0x01, 0x11, 0x7e, 0x42, 0x2a, 0x21, 0x10,
    0x20, 0x10, 0x0b,
};

const many_more_locals_wasm = [_]u8{
    0x00, 0x61, 0x73, 0x6d, 0x01, 0x00, 0x00, 0x00,
    0x01, 0x05, 0x01, 0x60, 0x00, 0x01, 0x7e, 0x03,
    0x02, 0x01, 0x00, 0x07, 0x08, 0x01, 0x04, 'm',
    'a',  'i',  'n',  0x00, 0x00, 0x0a, 0x0c, 0x01,
    0x0a, 0x01, 0x41, 0x7e, 0x42, 0x2a, 0x21, 0x40,
    0x20, 0x40, 0x0b,
};

const deep_control_wasm = [_]u8{
    0x00, 0x61, 0x73, 0x6d, 0x01, 0x00, 0x00, 0x00,
    0x01, 0x05, 0x01, 0x60, 0x00, 0x01, 0x7e, 0x03,
    0x02, 0x01, 0x00, 0x07, 0x08, 0x01, 0x04, 'm',
    'a',  'i',  'n',  0x00, 0x00, 0x0a, 0x39, 0x01,
    0x37, 0x00, 0x02, 0x40, 0x02, 0x40, 0x02, 0x40,
    0x02, 0x40, 0x02, 0x40, 0x02, 0x40, 0x02, 0x40,
    0x02, 0x40, 0x02, 0x40, 0x02, 0x40, 0x02, 0x40,
    0x02, 0x40, 0x02, 0x40, 0x02, 0x40, 0x02, 0x40,
    0x02, 0x40, 0x02, 0x40, 0x0b, 0x0b, 0x0b, 0x0b,
    0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b,
    0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x42, 0x2a, 0x0b,
};
...
const six_param_wasm = [_]u8{
    0x00, 0x61, 0x73, 0x6d, 0x01, 0x00, 0x00, 0x00,
    0x01, 0x0b, 0x01, 0x60, 0x06, 0x7e, 0x7e, 0x7e,
    0x7e, 0x7e, 0x7e, 0x01, 0x7e, 0x03, 0x02, 0x01,
    0x00, 0x07, 0x07, 0x01, 0x03, 's',  'i',  'x',
    0x00, 0x00, 0x0a, 0x06, 0x01, 0x04, 0x00, 0x20,
    0x05, 0x0b,
};

const nine_param_wasm = [_]u8{
    0x00, 0x61, 0x73, 0x6d, 0x01, 0x00, 0x00, 0x00,
    0x01, 0x0e, 0x01, 0x60, 0x09, 0x7e, 0x7e, 0x7e,
    0x7e, 0x7e, 0x7e, 0x7e, 0x7e, 0x7e, 0x01, 0x7e,
    0x03, 0x02, 0x01, 0x00, 0x07, 0x08, 0x01, 0x04,
    'n',  'i',  'n',  'e',  0x00, 0x00, 0x0a, 0x06,
    0x01, 0x04, 0x00, 0x20, 0x08, 0x0b,
};
...
const typed_block_type_index_wasm = [_]u8{
    0x00, 0x61, 0x73, 0x6d, 0x01, 0x00, 0x00, 0x00,
    0x01, 0x05, 0x01, 0x60, 0x00, 0x01, 0x7e, 0x03,
    0x02, 0x01, 0x00, 0x07, 0x08, 0x01, 0x04, 'm',
    'a',  'i',  'n',  0x00, 0x00, 0x0a, 0x09, 0x01,
    0x07, 0x00, 0x02, 0x00, 0x42, 0x2a, 0x0b, 0x0b,
};
...
test "wasm interpreter executes float min max and copysign" {
    var memory: [256]u8 = undefined;
    var ticks: u64 = 24;
    var runtime = wasm.Runtime.init(&memory, &ticks);

    const result = try wasm.executeExportValues(&runtime, &float_min_max_copysign_wasm, "main");
    try std.testing.expectEqual(@as(u32, 0x80000000), @as(u32, @bitCast(try result.valueF32(0))));
    try std.testing.expectEqual(@as(u32, 0x00000000), @as(u32, @bitCast(try result.valueF32(1))));
    try std.testing.expectEqual(@as(u32, 0xbfc00000), @as(u32, @bitCast(try result.valueF32(2))));
    try std.testing.expectEqual(@as(u64, 0xbff8000000000000), @as(u64, @bitCast(try result.valueF64(3))));
}

test "wasm interpreter executes f32 rounding unary operations" {
    var memory: [256]u8 = undefined;
    var ticks: u64 = 24;
    var runtime = wasm.Runtime.init(&memory, &ticks);

    const result = try wasm.executeExportValues(&runtime, &f32_rounding_wasm, "main");
    try std.testing.expectEqual(@as(u32, 0x40000000), @as(u32, @bitCast(try result.valueF32(0))));
    try std.testing.expectEqual(@as(u32, 0x3f800000), @as(u32, @bitCast(try result.valueF32(1))));
    try std.testing.expectEqual(@as(u32, 0xbf800000), @as(u32, @bitCast(try result.valueF32(2))));
    try std.testing.expectEqual(@as(u32, 0x40000000), @as(u32, @bitCast(try result.valueF32(3))));
}

test "wasm interpreter executes f64 rounding unary operations" {
    var memory: [256]u8 = undefined;
    var ticks: u64 = 24;
    var runtime = wasm.Runtime.init(&memory, &ticks);

    const result = try wasm.executeExportValues(&runtime, &f64_rounding_wasm, "main");
    try std.testing.expectEqual(@as(u64, 0x4000000000000000), @as(u64, @bitCast(try result.valueF64(0))));
    try std.testing.expectEqual(@as(u64, 0x3ff0000000000000), @as(u64, @bitCast(try result.valueF64(1))));
    try std.testing.expectEqual(@as(u64, 0xbff0000000000000), @as(u64, @bitCast(try result.valueF64(2))));
    try std.testing.expectEqual(@as(u64, 0x4000000000000000), @as(u64, @bitCast(try result.valueF64(3))));
}
...
test "wasm interpreter executes generated functions with more than sixteen locals" {
    var memory: [256]u8 = undefined;
    var ticks: u64 = 8;

    try std.testing.expectEqual(@as(i64, 42), try executeRuntime(&memory, &ticks, &many_locals_wasm));
}

test "wasm interpreter executes generated functions with more than sixty-four locals" {
    var memory: [256]u8 = undefined;
    var ticks: u64 = 8;

    try std.testing.expectEqual(@as(i64, 42), try executeRuntime(&memory, &ticks, &many_more_locals_wasm));
}

test "wasm interpreter executes generated functions with more than sixteen nested blocks" {
    var memory: [256]u8 = undefined;
    var ticks: u64 = 128;

    try std.testing.expectEqual(@as(i64, 42), try executeRuntime(&memory, &ticks, &deep_control_wasm));
}
...
test "wasm interpreter parses generated signatures with more than five params" {
    var memory: [256]u8 = undefined;
    var ticks: u64 = 8;
    var runtime = wasm.Runtime.init(&memory, &ticks);

    try std.testing.expectEqual(@as(i64, 42), try wasm.executeExportI64Args(&runtime, &six_param_wasm, "six", &.{ 1, 2, 3, 4, 5, 42 }));
}

test "wasm interpreter parses generated signatures with more than eight params" {
    var memory: [256]u8 = undefined;
    var ticks: u64 = 8;
    var runtime = wasm.Runtime.init(&memory, &ticks);

    try std.testing.expectEqual(@as(i64, 42), try wasm.executeExportI64Args(&runtime, &nine_param_wasm, "nine", &.{ 1, 2, 3, 4, 5, 6, 7, 8, 42 }));
}
...
test "wasm interpreter accepts block type indices" {
    var memory: [256]u8 = undefined;
    var ticks: u64 = 8;

    try std.testing.expectEqual(@as(i64, 42), try executeRuntime(&memory, &ticks, &typed_block_type_index_wasm));
}
