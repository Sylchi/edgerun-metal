...
pub const ui_component_common = @import("../ui_component_common.zig");
...
pub const packed_text_vertex_float_stride: usize = renderer_pipeline.text_vertex_float_stride;
...
pub const max_packed_text_vertices: usize = 98304;
...
pub const max_packed_overlay_text_vertices: usize = 8192;
...
pub var source_file_entries: [max_source_file_entries]app_source.FileEntry = undefined;
...
pub var packed_text_vertex_floats: [max_packed_text_vertices * packed_text_vertex_float_stride]f32 = undefined;
...
pub var packed_overlay_text_vertex_floats: [max_packed_overlay_text_vertices * packed_text_vertex_float_stride]f32 = undefined;
pub var packed_overlay_text_vertex_float_len: usize = 0;
