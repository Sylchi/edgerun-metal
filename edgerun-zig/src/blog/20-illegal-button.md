...
A device can be physically yours while legally and technically controlled by others.
...
Buying a device does not always mean gaining full authority over the device.

## EdgeRun seed

User-owned systems should minimize vendor-controlled chokepoints and keep the legal and technical boundaries honest instead of hiding them behind a friendly app icon.
