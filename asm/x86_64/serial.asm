...
; Macro: write 8-bit value to I/O port
%macro er_outb 2
    mov     al, %2
    mov     dx, %1
    out     dx, al
...
; Macro: read 8-bit value from I/O port into AL
%macro er_inb 1
    mov     dx, %1
    in      al, dx
%endmacro

; Low-level I/O primitives for use where port is already in dx and value in al.
; Override in hosted-test mode to avoid real I/O instructions.
