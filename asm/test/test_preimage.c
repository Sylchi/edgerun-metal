...
extern int  er_preimage_encode_epoch(const void* stamp, uint8_t out[64], uint32_t out_len);
extern int  er_preimage_decode_epoch(const uint8_t in[64], uint32_t in_len, void* stamp);
