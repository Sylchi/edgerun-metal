...
#define ER_UI_COMPONENT_SHOWCASE_GRID_MIN_CARD_W 108.0f
#define ER_UI_COMPONENT_SHOWCASE_GRID_MAX_COLUMNS 10u
#define ER_UI_COMPONENT_SHOWCASE_GRID_GAP 6.0f
#define ER_UI_COMPONENT_SHOWCASE_CARD_PAD 10.0f
#define ER_UI_COMPONENT_SHOWCASE_CARD_HEADER_H 30.0f
#define ER_UI_COMPONENT_SHOWCASE_CARD_PREVIEW_MIN_W 180.0f
#define ER_UI_COMPONENT_SHOWCASE_CARD_PREVIEW_MIN_H 82.0f
