...
#define ER_UI_COMPONENT_SHOWCASE_GRID_MIN_CARD_W 220.0f
#define ER_UI_COMPONENT_SHOWCASE_GRID_MAX_COLUMNS 5u
#define ER_UI_COMPONENT_SHOWCASE_GRID_GAP 22.0f
#define ER_UI_COMPONENT_SHOWCASE_CARD_H 230.0f
#define ER_UI_COMPONENT_SHOWCASE_CARD_PAD 16.0f
#define ER_UI_COMPONENT_SHOWCASE_CARD_HEADER_H 46.0f
#define ER_UI_COMPONENT_SHOWCASE_CARD_PREVIEW_MIN_W 150.0f
#define ER_UI_COMPONENT_SHOWCASE_CARD_PREVIEW_MIN_H 88.0f
