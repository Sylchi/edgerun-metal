...
#define ER_UI_SHADCN_DEMO_SPEC( \
  ...
  { \
    ...
    fixture, \
    slots, \
    ER_UI_SHADCN_ARRAY_COUNT(slots), \
    states, \
    state_count, \
    ER_UI_SHADCN_STATUS_EXACT_PORT \
  }
#define ER_UI_SHADCN_DEMO(title, slug, category, source, fixture, slots, states) \
  ER_UI_SHADCN_DEMO_SPEC( \
    title, \
    slug, \
    category, \
    source, \
    ...
    slots, \
    states, \
    ER_UI_SHADCN_ARRAY_COUNT(states))
#define ER_UI_SHADCN_DEMO_EMPTY(title, slug, category, source, fixture, slots, states) \
  ER_UI_SHADCN_DEMO_SPEC( \
    title, \
    slug, \
    category, \
...
static const er_ui_shadcn_demo_spec_t shadcn_demo_components[] = {
  ...
  ER_UI_SHADCN_DEMO(
    "Badge",
    "badge",
    ER_UI_SHADCN_CATEGORY_FOUNDATION,
    "Badge",
    "badge",
    slots_badge,
    states_badge),
