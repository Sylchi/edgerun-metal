...
#define ER_UI_SHADCN_SUFFIX_TSX_LEN 4u
#define ER_UI_SHADCN_SUFFIX_TS_LEN 3u
#define ER_UI_SHADCN_SUFFIX_JSX_LEN 4u
...
#define ER_UI_SHADCN_PREVIEW_SHEET_FIELD_ID (ER_UI_SHADCN_DEMO_PREVIEW_BASE_ID + 42u)
#define ER_UI_SHADCN_PREVIEW_SHEET_SAVE_ID (ER_UI_SHADCN_DEMO_PREVIEW_BASE_ID + 43u)
#define ER_UI_SHADCN_PREVIEW_SIDEBAR_DASHBOARD_ID (ER_UI_SHADCN_DEMO_PREVIEW_BASE_ID + 78u)
#define ER_UI_SHADCN_PREVIEW_SIDEBAR_TRANSACTIONS_ID (ER_UI_SHADCN_DEMO_PREVIEW_BASE_ID + 79u)
#define ER_UI_SHADCN_PREVIEW_SLIDER_ID (ER_UI_SHADCN_DEMO_PREVIEW_BASE_ID + 21u)
#define ER_UI_SHADCN_PREVIEW_SWITCH_ID (ER_UI_SHADCN_DEMO_PREVIEW_BASE_ID + 22u)
#define ER_UI_SHADCN_PREVIEW_TABS_ID (ER_UI_SHADCN_DEMO_PREVIEW_BASE_ID + 23u)
#define ER_UI_SHADCN_PREVIEW_TEXTAREA_ID (ER_UI_SHADCN_DEMO_PREVIEW_BASE_ID + 45u)
#define ER_UI_SHADCN_PREVIEW_TOGGLE_ID (ER_UI_SHADCN_DEMO_PREVIEW_BASE_ID + 24u)
#define ER_UI_SHADCN_PREVIEW_TOGGLE_GROUP_ID (ER_UI_SHADCN_DEMO_PREVIEW_BASE_ID + 44u)
#define ER_UI_SHADCN_PREVIEW_TOOLTIP_ID (ER_UI_SHADCN_DEMO_PREVIEW_BASE_ID + 26u)
...
static bool er_ui_shadcn_ends_with_len(const char* start, const char* end, const char* suffix, size_t suffix_len) {
...
static er_ui_status_t er_ui_shadcn_push_icon(
  er_ui_scene_t* scene,
...
static er_ui_status_t er_ui_shadcn_icon_tile(
  er_ui_scene_t* scene,
  er_ui_bounds_t bounds,
...
static er_ui_status_t er_ui_shadcn_row_body_emit(
  er_ui_scene_t* scene,
  vr_font_face_t* font,
  er_ui_bounds_t bounds,
  er_ui_resolved_theme_t theme,
  ...
  if (status != ER_UI_OK) return status;
  if (detail[0]) {
    status = er_ui_shadcn_push_ascii_text(scene, font, detail, bounds.x + 12.0f, bounds.y + 44.0f, theme.colors.muted);
    if (status != ER_UI_OK) return status;
  }
  return ER_UI_OK;
}
...
static const er_ui_shadcn_demo_spec_t shadcn_demo_components[] = {
  {"Accordion", "accordion", "/docs/components/accordion", ER_UI_SHADCN_CATEGORY_LAYOUT, "Accordion", "accordion_node", slots_accordion, ER_UI_SHADCN_ARRAY_COUNT(slots_accordion), states_accordion, ER_UI_SHADCN_ARRAY_COUNT(states_accordion), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Alert", "alert", "/docs/components/alert", ER_UI_SHADCN_CATEGORY_FEEDBACK, "Alert", "alert_node", slots_alert, ER_UI_SHADCN_ARRAY_COUNT(slots_alert), states_alert, ER_UI_SHADCN_ARRAY_COUNT(states_alert), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Alert Dialog", "alert-dialog", "/docs/components/alert-dialog", ER_UI_SHADCN_CATEGORY_OVERLAY, "AlertDialog", "alert_dialog_node", slots_alert_dialog, ER_UI_SHADCN_ARRAY_COUNT(slots_alert_dialog), states_alert_dialog, ER_UI_SHADCN_ARRAY_COUNT(states_alert_dialog), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Aspect Ratio", "aspect-ratio", "/docs/components/aspect-ratio", ER_UI_SHADCN_CATEGORY_MEDIA, "AspectRatio", "aspect_ratio_node", slots_aspect_ratio, ER_UI_SHADCN_ARRAY_COUNT(slots_aspect_ratio), states_aspect_ratio, ER_UI_SHADCN_EMPTY_COUNT, ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Avatar", "avatar", "/docs/components/avatar", ER_UI_SHADCN_CATEGORY_DATA_DISPLAY, "Avatar", "avatar_node", slots_avatar, ER_UI_SHADCN_ARRAY_COUNT(slots_avatar), states_avatar, ER_UI_SHADCN_ARRAY_COUNT(states_avatar), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Badge", "badge", "/docs/components/badge", ER_UI_SHADCN_CATEGORY_FOUNDATION, "Badge", "badge", slots_badge, ER_UI_SHADCN_ARRAY_COUNT(slots_badge), states_badge, ER_UI_SHADCN_ARRAY_COUNT(states_badge), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Breadcrumb", "breadcrumb", "/docs/components/breadcrumb", ER_UI_SHADCN_CATEGORY_NAVIGATION, "Breadcrumb", "breadcrumb", slots_breadcrumb, ER_UI_SHADCN_ARRAY_COUNT(slots_breadcrumb), states_breadcrumb, ER_UI_SHADCN_ARRAY_COUNT(states_breadcrumb), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Button", "button", "/docs/components/button", ER_UI_SHADCN_CATEGORY_FOUNDATION, "Button", "button", slots_button, ER_UI_SHADCN_ARRAY_COUNT(slots_button), states_button, ER_UI_SHADCN_ARRAY_COUNT(states_button), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Button Group", "button-group", "/docs/components/button-group", ER_UI_SHADCN_CATEGORY_FOUNDATION, "ButtonGroup", "button_group_node", slots_button_group, ER_UI_SHADCN_ARRAY_COUNT(slots_button_group), states_button_group, ER_UI_SHADCN_ARRAY_COUNT(states_button_group), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Calendar", "calendar", "/docs/components/calendar", ER_UI_SHADCN_CATEGORY_FORM, "Calendar", "calendar_node", slots_calendar, ER_UI_SHADCN_ARRAY_COUNT(slots_calendar), states_calendar, ER_UI_SHADCN_ARRAY_COUNT(states_calendar), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Card", "card", "/docs/components/card", ER_UI_SHADCN_CATEGORY_LAYOUT, "Card", "card", slots_card, ER_UI_SHADCN_ARRAY_COUNT(slots_card), states_card, ER_UI_SHADCN_ARRAY_COUNT(states_card), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Carousel", "carousel", "/docs/components/carousel", ER_UI_SHADCN_CATEGORY_MEDIA, "Carousel", "carousel_node", slots_carousel, ER_UI_SHADCN_ARRAY_COUNT(slots_carousel), states_carousel, ER_UI_SHADCN_ARRAY_COUNT(states_carousel), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Chart", "chart", "/docs/components/chart", ER_UI_SHADCN_CATEGORY_DATA_DISPLAY, "Chart", "chart_node", slots_chart, ER_UI_SHADCN_ARRAY_COUNT(slots_chart), states_chart, ER_UI_SHADCN_ARRAY_COUNT(states_chart), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Checkbox", "checkbox", "/docs/components/checkbox", ER_UI_SHADCN_CATEGORY_FORM, "Checkbox", "checkbox", slots_checkbox, ER_UI_SHADCN_ARRAY_COUNT(slots_checkbox), states_checkbox, ER_UI_SHADCN_ARRAY_COUNT(states_checkbox), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Collapsible", "collapsible", "/docs/components/collapsible", ER_UI_SHADCN_CATEGORY_LAYOUT, "Collapsible", "collapsible_node", slots_collapsible, ER_UI_SHADCN_ARRAY_COUNT(slots_collapsible), states_collapsible, ER_UI_SHADCN_ARRAY_COUNT(states_collapsible), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Combobox", "combobox", "/docs/components/combobox", ER_UI_SHADCN_CATEGORY_FORM, "Combobox", "combobox_node", slots_combobox, ER_UI_SHADCN_ARRAY_COUNT(slots_combobox), states_combobox, ER_UI_SHADCN_ARRAY_COUNT(states_combobox), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Command", "command", "/docs/components/command", ER_UI_SHADCN_CATEGORY_OVERLAY, "Command", "command_palette", slots_command, ER_UI_SHADCN_ARRAY_COUNT(slots_command), states_command, ER_UI_SHADCN_ARRAY_COUNT(states_command), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Context Menu", "context-menu", "/docs/components/context-menu", ER_UI_SHADCN_CATEGORY_OVERLAY, "ContextMenu", "context_menu_node", slots_context_menu, ER_UI_SHADCN_ARRAY_COUNT(slots_context_menu), states_context_menu, ER_UI_SHADCN_ARRAY_COUNT(states_context_menu), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Data Table", "data-table", "/docs/components/data-table", ER_UI_SHADCN_CATEGORY_DATA_DISPLAY, "DataTable", "data_table_node", slots_data_table, ER_UI_SHADCN_ARRAY_COUNT(slots_data_table), states_data_table, ER_UI_SHADCN_ARRAY_COUNT(states_data_table), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Date Picker", "date-picker", "/docs/components/date-picker", ER_UI_SHADCN_CATEGORY_FORM, "DatePicker", "date_picker_node", slots_date_picker, ER_UI_SHADCN_ARRAY_COUNT(slots_date_picker), states_date_picker, ER_UI_SHADCN_ARRAY_COUNT(states_date_picker), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Dialog", "dialog", "/docs/components/dialog", ER_UI_SHADCN_CATEGORY_OVERLAY, "Dialog", "dialog", slots_dialog, ER_UI_SHADCN_ARRAY_COUNT(slots_dialog), states_dialog, ER_UI_SHADCN_ARRAY_COUNT(states_dialog), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Direction", "direction", "/docs/components/direction", ER_UI_SHADCN_CATEGORY_FOUNDATION, "DirectionProvider", "direction_node", slots_direction, ER_UI_SHADCN_ARRAY_COUNT(slots_direction), states_direction, ER_UI_SHADCN_ARRAY_COUNT(states_direction), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Drawer", "drawer", "/docs/components/drawer", ER_UI_SHADCN_CATEGORY_OVERLAY, "Drawer", "drawer_node", slots_drawer, ER_UI_SHADCN_ARRAY_COUNT(slots_drawer), states_drawer, ER_UI_SHADCN_ARRAY_COUNT(states_drawer), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Dropdown Menu", "dropdown-menu", "/docs/components/dropdown-menu", ER_UI_SHADCN_CATEGORY_OVERLAY, "DropdownMenu", "dropdown_menu_node", slots_dropdown_menu, ER_UI_SHADCN_ARRAY_COUNT(slots_dropdown_menu), states_dropdown_menu, ER_UI_SHADCN_ARRAY_COUNT(states_dropdown_menu), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Empty", "empty", "/docs/components/empty", ER_UI_SHADCN_CATEGORY_FEEDBACK, "Empty", "empty_state", slots_empty, ER_UI_SHADCN_ARRAY_COUNT(slots_empty), states_empty, ER_UI_SHADCN_ARRAY_COUNT(states_empty), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Field", "field", "/docs/components/field", ER_UI_SHADCN_CATEGORY_FORM, "Field", "field_node", slots_field, ER_UI_SHADCN_ARRAY_COUNT(slots_field), states_field, ER_UI_SHADCN_ARRAY_COUNT(states_field), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Hover Card", "hover-card", "/docs/components/hover-card", ER_UI_SHADCN_CATEGORY_OVERLAY, "HoverCard", "hover_card_node", slots_hover_card, ER_UI_SHADCN_ARRAY_COUNT(slots_hover_card), states_hover_card, ER_UI_SHADCN_ARRAY_COUNT(states_hover_card), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Input", "input", "/docs/components/input", ER_UI_SHADCN_CATEGORY_FORM, "Input", "field_node", slots_input, ER_UI_SHADCN_ARRAY_COUNT(slots_input), states_input, ER_UI_SHADCN_ARRAY_COUNT(states_input), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Input Group", "input-group", "/docs/components/input-group", ER_UI_SHADCN_CATEGORY_FORM, "InputGroup", "input_group_node", slots_input_group, ER_UI_SHADCN_ARRAY_COUNT(slots_input_group), states_input_group, ER_UI_SHADCN_ARRAY_COUNT(states_input_group), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Input OTP", "input-otp", "/docs/components/input-otp", ER_UI_SHADCN_CATEGORY_FORM, "InputOTP", "input_otp_node", slots_input_otp, ER_UI_SHADCN_ARRAY_COUNT(slots_input_otp), states_input_otp, ER_UI_SHADCN_ARRAY_COUNT(states_input_otp), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Item", "item", "/docs/components/item", ER_UI_SHADCN_CATEGORY_DATA_DISPLAY, "Item", "list_row_node", slots_item, ER_UI_SHADCN_ARRAY_COUNT(slots_item), states_item, ER_UI_SHADCN_ARRAY_COUNT(states_item), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Kbd", "kbd", "/docs/components/kbd", ER_UI_SHADCN_CATEGORY_FOUNDATION, "Kbd", "kbd_node", slots_kbd, ER_UI_SHADCN_ARRAY_COUNT(slots_kbd), states_kbd, ER_UI_SHADCN_EMPTY_COUNT, ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Label", "label", "/docs/components/label", ER_UI_SHADCN_CATEGORY_FORM, "Label", "text", slots_label, ER_UI_SHADCN_ARRAY_COUNT(slots_label), states_label, ER_UI_SHADCN_ARRAY_COUNT(states_label), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Menubar", "menubar", "/docs/components/menubar", ER_UI_SHADCN_CATEGORY_NAVIGATION, "Menubar", "menubar_node", slots_menubar, ER_UI_SHADCN_ARRAY_COUNT(slots_menubar), states_menubar, ER_UI_SHADCN_ARRAY_COUNT(states_menubar), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Native Select", "native-select", "/docs/components/native-select", ER_UI_SHADCN_CATEGORY_FORM, "NativeSelect", "select_node", slots_native_select, ER_UI_SHADCN_ARRAY_COUNT(slots_native_select), states_native_select, ER_UI_SHADCN_ARRAY_COUNT(states_native_select), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Navigation Menu", "navigation-menu", "/docs/components/navigation-menu", ER_UI_SHADCN_CATEGORY_NAVIGATION, "NavigationMenu", "navigation_menu_node", slots_navigation_menu, ER_UI_SHADCN_ARRAY_COUNT(slots_navigation_menu), states_navigation_menu, ER_UI_SHADCN_ARRAY_COUNT(states_navigation_menu), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Pagination", "pagination", "/docs/components/pagination", ER_UI_SHADCN_CATEGORY_NAVIGATION, "Pagination", "pagination_node", slots_pagination, ER_UI_SHADCN_ARRAY_COUNT(slots_pagination), states_pagination, ER_UI_SHADCN_ARRAY_COUNT(states_pagination), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Popover", "popover", "/docs/components/popover", ER_UI_SHADCN_CATEGORY_OVERLAY, "Popover", "popover_node", slots_popover, ER_UI_SHADCN_ARRAY_COUNT(slots_popover), states_popover, ER_UI_SHADCN_ARRAY_COUNT(states_popover), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Progress", "progress", "/docs/components/progress", ER_UI_SHADCN_CATEGORY_FEEDBACK, "Progress", "progress_bar_node", slots_progress, ER_UI_SHADCN_ARRAY_COUNT(slots_progress), states_progress, ER_UI_SHADCN_ARRAY_COUNT(states_progress), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Radio Group", "radio-group", "/docs/components/radio-group", ER_UI_SHADCN_CATEGORY_FORM, "RadioGroup", "radio", slots_radio_group, ER_UI_SHADCN_ARRAY_COUNT(slots_radio_group), states_radio_group, ER_UI_SHADCN_ARRAY_COUNT(states_radio_group), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Resizable", "resizable", "/docs/components/resizable", ER_UI_SHADCN_CATEGORY_LAYOUT, "Resizable", "resizable_node", slots_resizable, ER_UI_SHADCN_ARRAY_COUNT(slots_resizable), states_resizable, ER_UI_SHADCN_ARRAY_COUNT(states_resizable), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Scroll Area", "scroll-area", "/docs/components/scroll-area", ER_UI_SHADCN_CATEGORY_LAYOUT, "ScrollArea", "scroll_area", slots_scroll_area, ER_UI_SHADCN_ARRAY_COUNT(slots_scroll_area), states_scroll_area, ER_UI_SHADCN_ARRAY_COUNT(states_scroll_area), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Select", "select", "/docs/components/select", ER_UI_SHADCN_CATEGORY_FORM, "Select", "select_node", slots_select, ER_UI_SHADCN_ARRAY_COUNT(slots_select), states_select, ER_UI_SHADCN_ARRAY_COUNT(states_select), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Separator", "separator", "/docs/components/separator", ER_UI_SHADCN_CATEGORY_LAYOUT, "Separator", "divider", slots_separator, ER_UI_SHADCN_ARRAY_COUNT(slots_separator), states_separator, ER_UI_SHADCN_ARRAY_COUNT(states_separator), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Sheet", "sheet", "/docs/components/sheet", ER_UI_SHADCN_CATEGORY_OVERLAY, "Sheet", "sheet_node", slots_sheet, ER_UI_SHADCN_ARRAY_COUNT(slots_sheet), states_sheet, ER_UI_SHADCN_ARRAY_COUNT(states_sheet), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Sidebar", "sidebar", "/docs/components/sidebar", ER_UI_SHADCN_CATEGORY_NAVIGATION, "Sidebar", "sidebar_node", slots_sidebar, ER_UI_SHADCN_ARRAY_COUNT(slots_sidebar), states_sidebar, ER_UI_SHADCN_ARRAY_COUNT(states_sidebar), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Skeleton", "skeleton", "/docs/components/skeleton", ER_UI_SHADCN_CATEGORY_FEEDBACK, "Skeleton", "skeleton", slots_skeleton, ER_UI_SHADCN_ARRAY_COUNT(slots_skeleton), states_skeleton, ER_UI_SHADCN_ARRAY_COUNT(states_skeleton), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Slider", "slider", "/docs/components/slider", ER_UI_SHADCN_CATEGORY_FORM, "Slider", "slider_node", slots_slider, ER_UI_SHADCN_ARRAY_COUNT(slots_slider), states_slider, ER_UI_SHADCN_ARRAY_COUNT(states_slider), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Sonner", "sonner", "/docs/components/sonner", ER_UI_SHADCN_CATEGORY_FEEDBACK, "Sonner", "toast", slots_sonner, ER_UI_SHADCN_ARRAY_COUNT(slots_sonner), states_sonner, ER_UI_SHADCN_ARRAY_COUNT(states_sonner), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Switch", "switch", "/docs/components/switch", ER_UI_SHADCN_CATEGORY_FORM, "Switch", "toggle_node", slots_switch, ER_UI_SHADCN_ARRAY_COUNT(slots_switch), states_switch, ER_UI_SHADCN_ARRAY_COUNT(states_switch), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Table", "table", "/docs/components/table", ER_UI_SHADCN_CATEGORY_DATA_DISPLAY, "Table", "table_node", slots_table, ER_UI_SHADCN_ARRAY_COUNT(slots_table), states_table, ER_UI_SHADCN_ARRAY_COUNT(states_table), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Tabs", "tabs", "/docs/components/tabs", ER_UI_SHADCN_CATEGORY_NAVIGATION, "Tabs", "tabs_node", slots_tabs, ER_UI_SHADCN_ARRAY_COUNT(slots_tabs), states_tabs, ER_UI_SHADCN_ARRAY_COUNT(states_tabs), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Textarea", "textarea", "/docs/components/textarea", ER_UI_SHADCN_CATEGORY_FORM, "Textarea", "text_area_node", slots_textarea, ER_UI_SHADCN_ARRAY_COUNT(slots_textarea), states_textarea, ER_UI_SHADCN_ARRAY_COUNT(states_textarea), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Toast", "toast", "/docs/components/toast", ER_UI_SHADCN_CATEGORY_FEEDBACK, "Toast", "toast", slots_toast, ER_UI_SHADCN_ARRAY_COUNT(slots_toast), states_toast, ER_UI_SHADCN_ARRAY_COUNT(states_toast), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Toggle", "toggle", "/docs/components/toggle", ER_UI_SHADCN_CATEGORY_FOUNDATION, "Toggle", "toggle_node", slots_toggle, ER_UI_SHADCN_ARRAY_COUNT(slots_toggle), states_toggle, ER_UI_SHADCN_ARRAY_COUNT(states_toggle), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Toggle Group", "toggle-group", "/docs/components/toggle-group", ER_UI_SHADCN_CATEGORY_FOUNDATION, "ToggleGroup", "toggle_group_node", slots_toggle_group, ER_UI_SHADCN_ARRAY_COUNT(slots_toggle_group), states_toggle_group, ER_UI_SHADCN_ARRAY_COUNT(states_toggle_group), ER_UI_SHADCN_STATUS_EXACT_PORT},
  {"Tooltip", "tooltip", "/docs/components/tooltip", ER_UI_SHADCN_CATEGORY_OVERLAY, "Tooltip", "tooltip", slots_tooltip, ER_UI_SHADCN_ARRAY_COUNT(slots_tooltip), states_tooltip, ER_UI_SHADCN_ARRAY_COUNT(states_tooltip), ER_UI_SHADCN_STATUS_EXACT_PORT},
};
...
er_ui_status_t er_ui_shadcn_button_emit(
  ...
  float text_w = (float)er_ui_shadcn_ascii_len(label) * 7.0f;
  float text_x = rect.x + (rect.w - text_w) * 0.5f;
  if (text_x < rect.x + 10.0f) text_x = rect.x + 10.0f;
  return er_ui_shadcn_push_ascii_text(scene, font, label, text_x, rect.y + rect.h * 0.62f, er_ui_shadcn_button_text(theme, variant));
}
...
er_ui_status_t er_ui_shadcn_select_emit(
  ...
  if (status != ER_UI_OK) return status;
  return er_ui_shadcn_push_icon(scene, er_ui_bounds(control.x + control.w - 24.0f, control.y + (control.h - 16.0f) * 0.5f, 16.0f, 16.0f),
...
er_ui_status_t er_ui_shadcn_checkbox_emit(
  ...
  if (status != ER_UI_OK) return status;
  if (checked) {
    status = er_ui_shadcn_push_icon(scene, er_ui_bounds(box.x + 3.0f, box.y + 3.0f, 12.0f, 12.0f), ER_UI_ICON_CHECK, theme.colors.accent_text);
    if (status != ER_UI_OK) return status;
  }
...
er_ui_status_t er_ui_shadcn_tree_item_emit(
  ...
  status = er_ui_shadcn_push_icon(scene, er_ui_bounds(bounds.x + indent, bounds.y + (bounds.h - 16.0f) * 0.5f, 16.0f, 16.0f),
...
er_ui_status_t er_ui_shadcn_identity_card_emit(
  ...
  if (status != ER_UI_OK) return status;
  status = er_ui_shadcn_icon_tile(scene, er_ui_bounds(bounds.x + 16.0f, bounds.y + 18.0f, 34.0f, 34.0f), theme, ER_UI_ICON_SHIELD, theme.colors.accent);
  if (status != ER_UI_OK) return status;
...
er_ui_status_t er_ui_shadcn_thread_row_emit(
  ...
  if (status != ER_UI_OK) return status;
  status = er_ui_shadcn_icon_tile(scene, er_ui_bounds(bounds.x + 12.0f, bounds.y + 14.0f, 28.0f, 28.0f), theme, ER_UI_ICON_CHAT,
                                  unread ? theme.colors.accent : theme.colors.muted);
  if (status != ER_UI_OK) return status;
...
er_ui_status_t er_ui_shadcn_attachment_preview_emit(
  ...
  if (status != ER_UI_OK) return status;
  status = er_ui_shadcn_icon_tile(scene, er_ui_bounds(bounds.x + 12.0f, bounds.y + 12.0f, 28.0f, 28.0f), theme, ER_UI_ICON_FILE, theme.colors.accent);
  if (status != ER_UI_OK) return status;
...
er_ui_status_t er_ui_shadcn_capability_grant_row_emit(
  ...
  if (status != ER_UI_OK) return status;
  status = er_ui_shadcn_icon_tile(scene, er_ui_bounds(bounds.x + 12.0f, bounds.y + 15.0f, 28.0f, 28.0f), theme, ER_UI_ICON_KEY, theme.colors.info);
  if (status != ER_UI_OK) return status;
...
er_ui_status_t er_ui_shadcn_proof_event_row_emit(
  ...
  status = er_ui_scene_push_rect(scene, er_ui_rect_fill(bounds.x, bounds.y, bounds.w, bounds.h, 0.0f, theme.colors.panel));
  if (status != ER_UI_OK) return status;
  status = er_ui_shadcn_icon_tile(scene, er_ui_bounds(bounds.x + 12.0f, bounds.y + 15.0f, 28.0f, 28.0f), theme, ER_UI_ICON_CHECK, theme.colors.success);
  if (status != ER_UI_OK) return status;
  status = er_ui_shadcn_push_ascii_text(scene, font, title, bounds.x + 48.0f, bounds.y + 24.0f, theme.colors.text);
  if (status != ER_UI_OK) return status;
...
er_ui_status_t er_ui_shadcn_package_card_emit(
  ...
  status = er_ui_shadcn_card_emit(scene, bounds, theme);
  if (status != ER_UI_OK) return status;
  status = er_ui_shadcn_icon_tile(scene, er_ui_bounds(bounds.x + 16.0f, bounds.y + 18.0f, 30.0f, 30.0f), theme, ER_UI_ICON_APP, theme.colors.accent);
  if (status != ER_UI_OK) return status;
...
er_ui_status_t er_ui_shadcn_receipt_row_emit(
  ...
  status = er_ui_scene_push_rect(scene, er_ui_rect_fill(bounds.x, bounds.y, bounds.w, bounds.h, 0.0f, theme.colors.panel));
  if (status != ER_UI_OK) return status;
  status = er_ui_shadcn_icon_tile(scene, er_ui_bounds(bounds.x + 12.0f, bounds.y + 15.0f, 28.0f, 28.0f), theme, ER_UI_ICON_WALLET, theme.colors.success);
  if (status != ER_UI_OK) return status;
...
er_ui_status_t er_ui_shadcn_panel_header_emit(
  ...
  er_ui_status_t status = er_ui_shadcn_push_ascii_text(scene, font, title, bounds.x, bounds.y + 20.0f, theme.colors.text);
  if (status != ER_UI_OK) return status;
  if (subtitle[0]) {
...
er_ui_status_t er_ui_shadcn_metric_card_emit(
  ...
  er_ui_status_t status = er_ui_shadcn_card_emit(scene, bounds, theme);
  if (status != ER_UI_OK) return status;
  status = er_ui_shadcn_push_ascii_text(scene, font, title, bounds.x + 14.0f, bounds.y + 24.0f, theme.colors.muted);
  if (status != ER_UI_OK) return status;
  status = er_ui_shadcn_push_ascii_text(scene, font, value, bounds.x + 14.0f, bounds.y + 56.0f, theme.colors.text);
  if (status != ER_UI_OK) return status;
  if (detail[0]) {
    status = er_ui_shadcn_push_ascii_text(scene, font, detail, bounds.x + 14.0f, bounds.y + 82.0f, theme.colors.muted);
    if (status != ER_UI_OK) return status;
  }
  if (has_progress) {
    return er_ui_shadcn_progress_emit(scene, er_ui_bounds(bounds.x + 14.0f, bounds.y + bounds.h - 18.0f, bounds.w - 28.0f, 8.0f),
                                      theme, progress);
  }
...
er_ui_status_t er_ui_shadcn_transaction_row_emit(
  ...
  er_ui_status_t status = er_ui_shadcn_row_body_emit(scene, font, bounds, theme, ER_UI_HIT_TRANSACTION_ROW, id, true, title, subtitle, 0.0f,
                                                     theme.colors.panel);
  if (status != ER_UI_OK) return status;
  status = er_ui_shadcn_push_ascii_text(scene, font, date, bounds.x + bounds.w - 170.0f, bounds.y + 22.0f, theme.colors.muted);
  if (status != ER_UI_OK) return status;
  status = er_ui_shadcn_push_ascii_text(scene, font, amount, bounds.x + bounds.w - 86.0f, bounds.y + 34.0f, positive ? theme.colors.success : theme.colors.danger);
  if (status != ER_UI_OK) return status;
  return er_ui_shadcn_separator_emit(scene, er_ui_bounds(bounds.x, bounds.y + bounds.h - 1.0f, bounds.w, 1.0f), theme);
}
...
er_ui_status_t er_ui_shadcn_menu_item_emit(
  ...
  er_ui_status_t status = er_ui_shadcn_row_body_emit(scene, font, bounds, theme, ER_UI_HIT_MENU_ITEM, id, true, label, detail, theme.radius.control, fill);
  if (status != ER_UI_OK) return status;
  if (badge[0]) {
    return er_ui_shadcn_badge_emit(scene, font, er_ui_bounds(bounds.x + bounds.w - 84.0f, bounds.y + 17.0f, 72.0f, 24.0f), theme, badge,
...
er_ui_status_t er_ui_shadcn_control_row_emit(
  ...
  er_ui_status_t status = er_ui_shadcn_row_body_emit(scene, font, bounds, theme, ER_UI_HIT_LIST_ROW, id, id != 0u, label, detail, 0.0f,
                                                     theme.colors.panel);
  if (status != ER_UI_OK) return status;
  if (accessory[0]) {
    status = er_ui_shadcn_push_ascii_text(scene, font, accessory, bounds.x + bounds.w - 116.0f, bounds.y + 34.0f, theme.colors.muted);
    if (status != ER_UI_OK) return status;
  }
  return er_ui_shadcn_separator_emit(scene, er_ui_bounds(bounds.x, bounds.y + bounds.h - 1.0f, bounds.w, 1.0f), theme);
}
...
er_ui_status_t er_ui_network_app_prompt_emit(
  ...
  status = er_ui_shadcn_icon_tile(scene, icon, theme, ER_UI_ICON_NETWORK, theme.colors.accent);
  if (status != ER_UI_OK) return status;

  const char* title = app_name[0] ? app_name : "Network app";
  status = er_ui_shadcn_push_ascii_text(scene, font, title, bounds.x + 70.0f, bounds.y + 34.0f, theme.colors.text);
  if (status != ER_UI_OK) return status;
  status = er_ui_shadcn_badge_emit(scene, font, er_ui_bounds(bounds.x + 70.0f, bounds.y + 46.0f, 118.0f, 24.0f), theme, "Network Storage",
                                   ER_UI_SHADCN_BADGE_SECONDARY);
  if (status != ER_UI_OK) return status;

  float text_x = bounds.x + 22.0f;
  float y = bounds.y + 96.0f;
  status = er_ui_shadcn_push_ascii_text(scene, font, "Signed package bytes are retrieved, verified, and run locally.", text_x, y, theme.colors.muted);
  if (status != ER_UI_OK) return status;
  y += 24.0f;
  status = er_ui_shadcn_push_ascii_text(scene, font, "Cache verified bytes to avoid repeated retrieval payments.", text_x, y, theme.colors.muted);
  if (status != ER_UI_OK) return status;
  ...
  if (status != ER_UI_OK) return status;
  if (package_size[0]) {
    status = er_ui_shadcn_push_ascii_text(scene, font, package_size, meta.x + 12.0f, meta.y + 22.0f, theme.colors.text);
    if (status != ER_UI_OK) return status;
  }
  if (retrieval_cost[0]) {
    status = er_ui_shadcn_push_ascii_text(scene, font, retrieval_cost, meta.x + meta.w * 0.38f, meta.y + 22.0f, theme.colors.text);
    if (status != ER_UI_OK) return status;
  }
  if (policy_hash[0]) {
    status = er_ui_shadcn_push_ascii_text(scene, font, policy_hash, meta.x + 12.0f, meta.y + 44.0f, theme.colors.muted);
    if (status != ER_UI_OK) return status;
  }
  ...
  status = er_ui_shadcn_button_emit(scene, font, run, theme, "Run once", run_once_id, ER_UI_SHADCN_BUTTON_SECONDARY, ER_UI_SHADCN_BUTTON_SIZE_SM, true);
  if (status != ER_UI_OK) return status;
  status = er_ui_shadcn_button_emit(scene, font, cache, theme, "Verify & cache", verify_cache_id, ER_UI_SHADCN_BUTTON_DEFAULT, ER_UI_SHADCN_BUTTON_SIZE_SM, true);
  if (status != ER_UI_OK) return status;
  return er_ui_shadcn_button_emit(scene, font, cancel, theme, "Cancel", cancel_id, ER_UI_SHADCN_BUTTON_GHOST, ER_UI_SHADCN_BUTTON_SIZE_SM, true);
}
...
er_ui_status_t er_ui_shadcn_component_scene_preview_emit(
  ...
  if (er_ui_shadcn_streq(slug, "sheet")) {
    ...
    status = er_ui_shadcn_field_emit(scene, font, er_ui_bounds(card.x + 16.0f, card.y + 62.0f, card.w - 32.0f, 58.0f), theme, "Name", "EdgeRun",
                                     ER_UI_SHADCN_PREVIEW_SHEET_FIELD_ID, false);
    if (status != ER_UI_OK) return status;
    return er_ui_shadcn_button_emit(scene, font, er_ui_bounds(card.x + 16.0f, card.y + 124.0f, 120.0f, 36.0f), theme, "Save changes",
                                    ER_UI_SHADCN_PREVIEW_SHEET_SAVE_ID, ER_UI_SHADCN_BUTTON_DEFAULT, ER_UI_SHADCN_BUTTON_SIZE_SM, true);
  }
  ...
  if (er_ui_shadcn_streq(slug, "slider")) {
    float value = er_ui_shadcn_demo_gallery_slider(state, ER_UI_SHADCN_PREVIEW_SLIDER_ID, 0.42f);
    return er_ui_shadcn_slider_emit(scene, font, er_ui_bounds(bounds.x, bounds.y, bounds.w, 48.0f), theme, "Volume", value, ER_UI_SHADCN_PREVIEW_SLIDER_ID);
  }
  if (er_ui_shadcn_streq(slug, "switch")) {
    er_ui_status_t status = er_ui_shadcn_switch_emit(scene, er_ui_bounds(bounds.x, bounds.y, 44.0f, 24.0f), theme, true, ER_UI_SHADCN_PREVIEW_SWITCH_ID);
    if (status != ER_UI_OK) return status;
  ...
  if (er_ui_shadcn_streq(slug, "textarea")) {
    return er_ui_shadcn_field_emit(scene, font, er_ui_bounds(bounds.x, bounds.y, bounds.w, 84.0f), theme, "Message", "Type your message here.",
                                   ER_UI_SHADCN_PREVIEW_TEXTAREA_ID, true);
  }
  ...
  if (er_ui_shadcn_streq(slug, "tooltip")) {
    er_ui_status_t status = er_ui_shadcn_button_emit(scene, font, er_ui_bounds(bounds.x, bounds.y, 80.0f, 38.0f), theme, "Hover",
                                                     ER_UI_SHADCN_PREVIEW_TOOLTIP_ID, ER_UI_SHADCN_BUTTON_SECONDARY, ER_UI_SHADCN_BUTTON_SIZE_SM, true);
    if (status != ER_UI_OK) return status;
