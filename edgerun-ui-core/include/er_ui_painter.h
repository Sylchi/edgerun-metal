...
er_ui_status_t er_ui_painter_fill_rect(
  er_ui_painter_t* painter,
  er_ui_bounds_t bounds,
  float radius,
  er_ui_color4_t color);
er_ui_status_t er_ui_painter_border_rect(
  er_ui_painter_t* painter,
  er_ui_bounds_t bounds,
  float radius,
  er_ui_color4_t color);
er_ui_status_t er_ui_painter_shadow_rect(
  er_ui_painter_t* painter,
  er_ui_bounds_t bounds,
  float radius,
  er_ui_color4_t color,
  float shadow);
er_ui_status_t er_ui_painter_panel(
  er_ui_painter_t* painter,
  er_ui_bounds_t bounds,
  float radius,
  er_ui_color4_t fill,
...
er_ui_status_t er_ui_painter_soft_card(
  er_ui_painter_t* painter,
  er_ui_bounds_t bounds,
  float radius,
  er_ui_color4_t fill);
er_ui_status_t er_ui_painter_divider(
  er_ui_painter_t* painter,
  float x,
  float y,
  float length,
  er_ui_axis_t axis,
  er_ui_color4_t color);
er_ui_status_t er_ui_painter_hit(
  er_ui_painter_t* painter,
  er_ui_hit_kind_t kind,
  uint32_t id,
  er_ui_bounds_t bounds);
er_ui_status_t er_ui_painter_drag_source(
  er_ui_painter_t* painter,
  uint32_t scope_id,
  uint32_t item_id,
  size_t index,
  er_ui_bounds_t bounds);
er_ui_status_t er_ui_painter_drop_target(
  er_ui_painter_t* painter,
  uint32_t scope_id,
  size_t index,
  er_ui_bounds_t bounds);
er_ui_status_t er_ui_painter_icon(
  er_ui_painter_t* painter,
  er_ui_bounds_t bounds,
  er_ui_icon_t icon,
  er_ui_color4_t color);
er_ui_status_t er_ui_painter_icon_quad(
  er_ui_painter_t* painter,
  er_ui_bounds_t bounds,
  float u0,
  float v0,
  ...
  float v1,
  er_ui_color4_t color);
er_ui_status_t er_ui_painter_text_quad(
  er_ui_painter_t* painter,
  er_ui_bounds_t bounds,
  float u0,
  float v0,
