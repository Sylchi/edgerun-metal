...
#define ER_UI_SHADCN_SELECT_CURRENCY_COUNT 3u
#define ER_UI_SHADCN_SELECT_ORDER_COUNT 3u
#define ER_UI_SHADCN_SELECT_TICKER_COUNT 4u
#define ER_UI_SHADCN_CHART_CONTRIBUTION_COUNT 7u
#define ER_UI_SHADCN_CHART_STOCK_COUNT 8u
#define ER_UI_SHADCN_CHART_POWER_COUNT 8u
#define ER_UI_SHADCN_CHART_CONTRIBUTION_DEFAULT_INDEX 5u
#define ER_UI_SHADCN_CHART_STOCK_DEFAULT_INDEX 5u
#define ER_UI_SHADCN_CHART_POWER_DEFAULT_INDEX 6u
